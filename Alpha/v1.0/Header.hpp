...
#define NGRAM_MODEL_WEIGHT 0.3  //weight to use for charater ngram data
#define TRIGRAM_LAMBDA 0.25   //TODO: optimize lambdas 
#define BIGRAM_LAMBDA  0.25
#define UNIGRAM_LAMBDA 0.25
#define QUADGRAM_LAMBDA 0.25
...
typedef unordered_map<U32,double> NgramModel;  // use only the bigram model for now. keys are U32 just for consistency;
